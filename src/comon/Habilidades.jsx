        ...
        <div className="w-full flex justify-center xs:p-8 sm:p-8 md:p-12 lg:p-16 xl:p-20">
            <div className='w-full flex flex-col p-10 sm:w-4/5 md:w-4/5 lg:w-4/5 rounded-md'>
                ...
                <div className='w-full flex lg:flex-row md:flex-col sm:flex-col xs:flex-col justify-center md:justify-center sm:justify-center xs:justify-center overflow-hidden'>
                    ...
                    <div className='flex flex-col lg:w-2/5 md:w-4/5 sm:w-4/5 xs:w-full md:text-center md:mt-20 p-4 m-auto mt-10 justify-center font-playwrite  text-2xl bg-slate-700 rounded-lg text-gray-300 '>
                    ...
                    <div className='flex flex-col lg:w-2/5 md:w-4/5 sm:w-4/5 xs:w-full md:text-center mt-10 md:mt-20 p-4 m-auto justify-center  font-playwrite text-2xl bg-slate-700 rounded-lg text-gray-300 '>
                    <div className='border-b-2 border-gray-800'>Backend:</div>
                    <div className='w-full flex flex-row flex-wrap pt-4 justify-center'>
