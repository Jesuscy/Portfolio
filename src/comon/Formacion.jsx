...
export const Formacion = () => {
  return (
    ...
    <div className='w-full  md:items-start sm:items-center xs:items-center sm:w-4/5 md:w-3/5 lg:w-2/5 flex flex-col bg-zinc-900 rounded-md'>
        <div className='w-full flex flex-col md:flex-row'>
            ...
            <div className='w-full md:w-1/3 mt-10 md:mt-20 flex justify-center'>
                <div className='flex justify-center items-center w-36 h-48'>
                    <img alt="Foto CV" className='w-full h-full border-2 border-fuchsia-700 object-cover rounded-full' />
                </div>
            </div>
        </div>
            
            <button className='w-1/3 mt-5 p-2 text-base font-mono rounded-lg hover:border hover:border-fuchsia-700 bg-zinc-800 text-gray-400'>Más Sobre Mí</button>
    </div>
</div>  )
}
